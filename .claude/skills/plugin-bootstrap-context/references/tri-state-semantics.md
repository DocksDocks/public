...
| `supabase@claude-plugins-official` | absent | Not installed by a flag-less sync; opted in per machine with `--supabase` |
| `n8n-mcp-skills@n8n-mcp-skills` | absent | Not installed (marketplace also dropped); opted in with `--n8n` |
