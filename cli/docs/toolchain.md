...
that the upgrade changes only the npm copy. A link in another PATH directory
that resolves into the prefix counts as the npm copy. A package that is not installed
