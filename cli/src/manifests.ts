...
import { pluginUserScopeInstalled } from "./engine-native/claudePluginPasses";
...
export const sotClaudeSettings = (): any => readJsonText(payloadText("SoT/.claude/settings.json"));
