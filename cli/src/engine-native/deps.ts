...
export const DEPENDENCIES: Record<ToolId, DependencySpec> = {
  ...
  curl: spec("curl", "required", (pf = process.platform) =>
  ...
  bun: spec("bun", "optional", (pf = process.platform) =>
