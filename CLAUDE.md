...
*Verified working: **rtk 0.40.0** ([release notes](https://github.com/rtk-ai/rtk/releases/tag/v0.40.0), 2026-05-15). Upgrade rationale and supply-chain notes live in commit messages; only the current verified version is recorded here.*
