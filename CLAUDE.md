...
|--------|--------|---------|
| `docks` | [DocksDocks/docks](https://github.com/DocksDocks/docks) | Multi-agent pipeline kit — Builder-Verifier patterns across 8 commands (security, fix, review, test, docs, refactor, human-docs, roadmap-init), 7 portable skills (Next.js, React 19, TypeScript, dep-vuln, lint discipline, UI polish, SOLID for React), 41 specialized subagents with per-phase Opus/Sonnet tiering |
